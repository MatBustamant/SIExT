...
public class BienService implements ServiceGenerico<BienDTO> {
    ...
    public BienDTO buscar(int idBien) throws NoSuchElementException {
        try (Connection con = BasedeDatos.getConnection()) {
            return this.buscar(idBien, true, con);
        } catch (SQLException ex) {
            System.getLogger(BienService.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        }
        return null;
    }
    ...
    public BienDTO buscar(int idBien, boolean checkEliminado) throws NoSuchElementException {
        try (Connection con = BasedeDatos.getConnection()) {
            return this.buscar(idBien, checkEliminado, con);
        } catch (SQLException ex) {
            System.getLogger(BienService.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        }
        return null;
    ...
    public BienDTO buscar(int idBien, boolean checkEliminado, Connection con) throws NoSuchElementException {
        Validador.validarId(idBien, CAMPO_ID_TEXT);
        BienDTO bien = bienDAO.buscar(idBien, con);
    ...
    void trasladar(int idBien, String nombreUbi, Connection con) throws NoSuchElementException {
        BienDTO bien = this.buscar(idBien, false, con);
        bienDAO.cambiarUbicacion(bien, nombreUbi, con);
    }
